...
const def = getTemplateDefinition('maroon-arch-islamic')
...
const countdownTitle = computed(() => inv.value.customization.text.countdownTitle || 'The Blessed Day')
...
<template>
  ...
  >
    ...
    <section id="hero-section" class="relative w-full overflow-hidden">
      ...
      <div class="relative z-10 mx-auto flex min-h-[92vh] max-w-lg flex-col items-center justify-end px-5 pb-36 pt-32 text-center">
    ...
    <div class="relative z-10 mx-auto max-w-lg px-5 pb-20">
      ...
      <section class="mt-6 text-center">
        <h2 class="mb-7 text-[11px] font-medium uppercase tracking-[0.3em] text-rose-800/80">
          <TemplateEditable field="countdownTitle" :value="countdownTitle" as="span" placeholder="The Blessed Day" />
        </h2>
      ...
      <footer class="mt-14 flex flex-col items-center text-center">
        <div class="mb-4 flex h-[52px] w-[52px] items-center justify-center rounded-full border border-rose-800/25 bg-white text-sm font-medium tracking-[0.15em] text-rose-900 shadow-sm">
          {{ monogram }}
        </div>
        <p class="max-w-[240px] text-[12.5px] font-light leading-relaxed tracking-wide text-rose-900/70">
          May Allah bless this beautiful union. We look forward to celebrating with you.
        </p>
