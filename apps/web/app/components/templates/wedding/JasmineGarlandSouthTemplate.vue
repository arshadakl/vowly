...
const def = getTemplateDefinition('jasmine-garland-south')
  ...
  >
    ...
    <section id="hero-section" class="relative w-full overflow-hidden">
      ...
      <div class="relative z-10 mx-auto flex min-h-[90vh] max-w-lg flex-col items-center justify-center px-5 pb-28 pt-14 text-center">
        <!-- Decorative jasmine flower -->
        <div class="mb-6 flex items-center gap-2">
          <div class="h-px w-8 bg-pink-300/70" />
          <span class="text-lg text-pink-400">❀</span>
          <div class="h-px w-8 bg-pink-300/70" />
        </div>
        ...
        <!-- Flower divider -->
        <div class="my-1.5 flex items-center gap-2 text-pink-500">
        ...
        <div class="mt-9 flex flex-col items-center gap-2.5 sm:flex-row sm:gap-4">
          <div class="flex items-center gap-2 rounded-full border border-pink-200/80 bg-white/75 px-4 py-1.5 backdrop-blur-sm">
            <Calendar :size="13" class="text-pink-600" />
          ...
          <div class="flex items-center gap-2 rounded-full border border-pink-200/80 bg-white/75 px-4 py-1.5 backdrop-blur-sm">
            <Clock :size="13" class="text-pink-600" />
            <span class="text-[12px] font-medium text-stone-700">
    ...
    <div class="relative z-10 mx-auto max-w-lg px-5 pb-20">
      <!-- Parents -->
      <section class="-mt-5 rounded-3xl border border-pink-100 bg-white/95 p-6 shadow-sm">
        <div class="mb-5 flex items-center justify-center gap-3">
          <div class="h-px flex-1 bg-gradient-to-r from-transparent to-pink-200" />
          <span class="text-[10px] uppercase tracking-[0.25em] text-pink-500">
            With the Blessings of
          </span>
          <div class="h-px flex-1 bg-gradient-to-l from-transparent to-pink-200" />
        </div>
        ...
        <div class="space-y-5 text-center">
          ...
          <div class="mx-auto flex items-center gap-2">
            <div class="h-px w-6 bg-pink-200" />
      ...
      <section class="mt-12 rounded-3xl border border-pink-100 bg-white p-6 shadow-sm">
        <div class="mb-4 flex items-center justify-center gap-2">
          <MapPin :size="15" class="text-pink-600" />
        ...
        <a
          ...
          class="mt-5 flex w-full items-center justify-center gap-2 rounded-full bg-pink-600 py-2.5 text-[13px] font-medium tracking-wide text-white transition hover:bg-pink-700 active:scale-[0.98]"
        >
      ...
      <footer class="mt-14 flex flex-col items-center text-center">
        <div class="mb-4 flex h-[52px] w-[52px] items-center justify-center rounded-full border border-pink-200 bg-white text-sm font-medium tracking-widest text-pink-800 shadow-sm">
          {{ monogram }}
        </div>
