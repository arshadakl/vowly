...
const def = getTemplateDefinition('red-gold-bridal')
...
const countdownTitle = computed(() => inv.value.customization.text.countdownTitle || 'The Auspicious Day')
  ...
  >
    ...
    <section id="hero-section" class="relative w-full overflow-hidden">
      <div class="absolute inset-0 z-0">
        <img
          ...
          loading="eager"
        >
        <div class="absolute inset-0 bg-gradient-to-b from-white/5 via-transparent to-[#fdf8f0]" />
      </div>
      ...
      <div class="relative z-10 mx-auto flex min-h-[94vh] max-w-lg flex-col items-center justify-end px-5 pb-40 pt-28 text-center sm:pb-44">
        ...
        <div class="mb-5 flex items-center gap-2">
          <div class="h-px w-8 bg-red-300/70" />
        ...
        <!-- Divider -->
        <div class="my-4 flex items-center gap-2 text-red-500">
        ...
        <div class="mt-7 flex flex-col items-center gap-2.5 sm:flex-row sm:gap-4">
          <div class="flex items-center gap-2 rounded-full border border-red-200/80 bg-white/75 px-4 py-1.5 backdrop-blur-sm">
            <Calendar :size="13" class="text-red-600" />
    ...
    <div class="relative z-10 mx-auto max-w-lg px-5 pb-20">
      ...
      <section class="mt-4 text-center">
        <h2 class="mb-7 text-[11px] font-medium uppercase tracking-[0.28em] text-red-700">
          <TemplateEditable field="countdownTitle" :value="countdownTitle" as="span" placeholder="The Auspicious Day" />
        </h2>
        <TemplateCountdown :date="weddingDate" :time-zone="weddingTz" />
      </section>

      <!-- Venue -->
      <section class="mt-12 rounded-3xl border border-red-100 bg-white p-6 shadow-sm">
        <div class="mb-4 flex items-center justify-center gap-2">
          <MapPin :size="15" class="text-red-600" />
          <span class="text-[10px] font-medium uppercase tracking-[0.25em] text-red-700">
            Venue
          </span>
        </div>
        ...
        <a
          ...
          class="mt-5 flex w-full items-center justify-center gap-2 rounded-full bg-red-700 py-2.5 text-[13px] font-medium tracking-wide text-white transition hover:bg-red-800 active:scale-[0.98]"
        >
      ...
      <footer class="mt-14 flex flex-col items-center text-center">
        <div
          class="mb-4 flex items-center justify-center rounded-full border border-red-200 bg-white text-sm font-medium tracking-widest text-red-800 shadow-sm"
