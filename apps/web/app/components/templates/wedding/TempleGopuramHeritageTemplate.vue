...
const def = getTemplateDefinition('temple-gopuram-heritage')
...
const heroEventText = computed(() => inv.value.customization.text.heroEventText || 'with the blessings of the divine invite you')
    ...
    <section id="hero-section" class="relative w-full overflow-hidden">
      <div class="absolute inset-0 z-0">
        <img
          ...
          loading="eager"
        >
        <div class="absolute inset-0 bg-gradient-to-b from-white/5 via-transparent to-[#faf6ef]" />
      </div>
      ...
      <div class="relative z-10 mx-auto flex min-h-[94vh] max-w-lg flex-col items-center justify-end px-5 pb-40 pt-28 text-center sm:pb-44">
        <div class="flex w-full flex-col items-center">
          <!-- Decorative top – hanging lamps 🪔 with amber lines -->
          <div class="mb-5 flex items-center gap-2">
            <div class="h-px w-8 bg-amber-400/60" />
          ...
          <p class="mt-5 max-w-[270px] text-[13.5px] font-light leading-relaxed text-stone-600">
            <TemplateEditable field="heroEventText" :value="heroEventText" as="span" placeholder="with the blessings of the divine invite you" />
          </p>

          <!-- Date & Time -->
          <div class="mt-7 flex flex-col items-center gap-2.5 sm:flex-row sm:gap-4">
            <div class="flex items-center gap-2 rounded-full border border-amber-300/60 bg-white/75 px-4 py-1.5 backdrop-blur-sm">
    ...
    <div class="relative z-10 mx-auto max-w-lg px-5 pb-20">
      ...
      <section class="mt-12 rounded-3xl border border-amber-200/70 bg-white p-6 shadow-sm">
        <div class="mb-4 flex items-center justify-center gap-2">
          ...
          <span class="text-[10px] font-medium uppercase tracking-[0.25em] text-amber-800">Venue</span>
        </div>
      ...
      <footer class="mt-14 flex flex-col items-center text-center">
        <div class="mb-4 flex items-center justify-center rounded-full border border-amber-300/60 bg-white text-sm font-medium tracking-widest text-amber-900 shadow-sm" style="width: 52px; height: 52px;">
          {{ monogram }}
        </div>
        <p class="max-w-[240px] text-[12.5px] font-light leading-relaxed text-stone-500">
          May the divine bless this sacred union with love, prosperity and joy.
        </p>
      </footer>
    </div>
  </div>
