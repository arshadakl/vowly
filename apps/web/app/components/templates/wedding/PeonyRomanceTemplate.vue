...
const def = getTemplateDefinition('peony-romance')
...
const countdownTitle = computed(() => inv.value.customization.text.countdownTitle || 'A Beautiful Beginning')
...
<template>
  ...
  >
    ...
    <section id="hero-section" class="relative w-full overflow-hidden">
      <div class="absolute inset-0 z-0">
        <img
          ...
          loading="eager"
        >
        <div class="absolute inset-0 bg-gradient-to-b from-white/5 via-transparent to-[#f9f4ee]" />
      </div>
      ...
      <div class="relative z-10 mx-auto flex min-h-[90vh] max-w-lg flex-col items-center justify-center px-5 pb-28 pt-14 text-center">
        ...
        <div class="mb-7 flex items-center gap-2.5">
          <div class="h-px w-9 bg-rose-800/35" />
          <Sparkles :size="13" class="text-rose-800/70" />
          <div class="h-px w-9 bg-rose-800/35" />
        </div>

        <!-- Names -->
        <h1 class="text-[2.15rem] font-medium tracking-wide text-rose-950 sm:text-[2.5rem]">
          <TemplateEditable field="groomName" :value="groomName" as="span" placeholder="Groom Name" />
        </h1>

        <div class="my-1.5 text-xl font-light text-rose-800/75">
          &amp;
        </div>
        ...
        <!-- Event text -->
        <div class="mt-5">
          <p class="max-w-[270px] text-[13.5px] font-light leading-relaxed text-rose-900/80">
        ...
        <div class="mt-9 flex flex-col items-center gap-2.5 sm:flex-row sm:gap-4">
          <div class="flex items-center gap-2 rounded-full border border-rose-800/20 bg-white/75 px-4 py-1.5 backdrop-blur-sm">
            ...
            <span class="text-[12px] font-medium text-rose-950">
    ...
    <div class="relative z-10 mx-auto max-w-lg px-5 pb-20">
      <!-- Parents -->
      <section class="-mt-5 rounded-3xl border border-rose-900/12 bg-white/95 p-6 shadow-sm">
        <div class="mb-5 flex items-center justify-center gap-3">
          <div class="h-px flex-1 bg-gradient-to-r from-transparent to-rose-800/25" />
          <span class="text-[10px] uppercase tracking-[0.28em] text-rose-800/70">
            With Love &amp; Blessings
          </span>
          <div class="h-px flex-1 bg-gradient-to-l from-transparent to-rose-800/25" />
        </div>

        <div class="space-y-5 text-center">
          <div>
            <p class="text-[14px] font-light leading-relaxed text-rose-950">
              <TemplateEditable field="groomParents" :value="groomParents" as="span" placeholder="Son of Mr. & Mrs. Rahman" multiline />
            </p>
          </div>
          <div class="mx-auto h-px w-11 bg-rose-800/20" />
          <div>
            <p class="text-[14px] font-light leading-relaxed text-rose-950">
      ...
      <section class="mt-12 text-center">
        <h2 class="mb-7 text-[11px] font-medium uppercase tracking-[0.3em] text-rose-800/80">
          <TemplateEditable field="countdownTitle" :value="countdownTitle" as="span" placeholder="A Beautiful Beginning" />
        </h2>
        <TemplateCountdown :date="weddingDate" :time-zone="weddingTz" />
      </section>

      <!-- Venue -->
      <section class="mt-12 rounded-3xl border border-rose-900/12 bg-white p-6 shadow-sm">
        <div class="mb-4 flex items-center justify-center gap-2">
          <MapPin :size="15" class="text-rose-800" />
          <span class="text-[10px] font-medium uppercase tracking-[0.26em] text-rose-800/80">
            Venue
          </span>
        </div>
        ...
        <p class="mt-1.5 text-center text-[13px] font-light text-rose-900/70">
      ...
      <footer class="mt-14 flex flex-col items-center text-center">
        <div
          class="mb-4 flex items-center justify-center rounded-full border border-rose-800/25 bg-white text-sm font-medium tracking-widest text-rose-900 shadow-sm"
          style="width: 52px; height: 52px"
        >
          {{ monogram }}
        </div>

        <p class="max-w-[240px] text-[12.5px] font-light leading-relaxed text-rose-900/70">
          We look forward to sharing this special day with you.
        </p>

        <div class="mt-5 flex items-center gap-2.5 text-rose-800/40">
          <div class="h-px w-7 bg-rose-800/25" />
